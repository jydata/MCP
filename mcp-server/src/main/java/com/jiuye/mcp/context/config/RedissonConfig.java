...
public class RedissonConfig {
    ...
    private int connectionMinimumIdleSize = 100;
    private int idleConnectionTimeout = 100000;
    private int pingTimeout = 100000;
    private int connectTimeout = 100000;
    private int timeout = 180000;
    private int retryAttempts = 6;
    private int retryInterval = 30000;
    private int reconnectionTimeout = 50000;
    private int failedAttempts = 6;
    private String password = null;
    private int subscriptionsPerConnection = 5;
    private String clientName = null;
    private int subscriptionConnectionMinimumIdleSize = 1;
    private int subscriptionConnectionPoolSize = 600;
    private int connectionPoolSize = 256;
    ...
    RedissonClient redisson() throws Exception {
        ...
        config.setKeepPubSubOrder(keepPubSubOrder).useSingleServer().setAddress(address)  //单例模式
